        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-xl font-bold">RemoteFix Pro</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-tech-light/80">
              <li><a href="#" className="hover:text-accent transition-colors">System Diagnostics</a></li>
              <li><a href="#" className="hover:text-accent transition-colors">Virus Removal</a></li>
              <li><a href="#" className="hover:text-accent transition-colors">Data Recovery</a></li>
              <li><a href="#" className="hover:text-accent transition-colors">Software Installation</a></li>
              <li><a href="#" className="hover:text-accent transition-colors">Network Setup</a></li>
              <li><a href="#" className="hover:text-accent transition-colors">System Optimization</a></li>
            </ul>
          </div>
