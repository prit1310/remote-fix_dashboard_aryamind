...
const AboutSection = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Trusted Remote PC and Laptop Repair Experts - RemoteFix Pro</title>
        <meta
          name="description"
          content="RemoteFix Pro is your professional partner for remote PC & laptop repair. An expert team ensures quick, secure, and reliable solutions for all tech issues."
        />
        <link rel="canonical" href="https://remotefix.shwetatech.com/about" />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content="Trusted Remote PC and Laptop Repair Experts - RemoteFix Pro"
        />
        <meta
          property="og:description"
          content="RemoteFix Pro is your professional partner for remote PC & laptop repair. An expert team ensures quick, secure, and reliable solutions for all tech issues."
        />
        <meta property="og:url" content="https://remotefix.shwetatech.com/about" />
